...
public class StoreCustomerMortality extends BaseFunction {
	/**
	 * 
	 */
	private static final long serialVersionUID = -134360533028883430L;
	private static final String FIELDS = "app_name,server_ip,req_time,num,req_date,status";
	private static final String TABLE_NAME = "customer_mortality";
