package com.liantuo.travel.customer.po;
...
public class OdsNginxTeamdbsPo {
	...
	public OdsNginxTeamdbsPo(ResultSet rs) throws SQLException {
		this.setTxid(rs.getLong("txid"));
		this.setCounts(rs.getLong("counts"));
		this.setPreCounts(rs.getLong("pre_counts"));
		this.setRespTime(rs.getDouble("resp_time"));
		this.setPreRespTime(rs.getDouble("pre_resp_time"));
		this.setSize(rs.getLong("size"));
		...
		// this.httpStatus = tuple.getStringByField("httpStatus");
		// this.reqUrlPath = tuple.getStringByField("reqUrlPath");
		// this.size = tuple.getLongByField("size");
		// this.reqDate = tuple.getStringByField("reqDate");
	}
