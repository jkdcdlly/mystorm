package com.liantuo.travel.customer.vo;
...
public class OdsNginxTeamdbsVo {
	...
	public OdsNginxTeamdbsVo(TridentTuple tuple, Long txid) {
		this.setTxid(txid);
		this.setAppName(tuple.getStringByField("appName"));
		this.setServerIP(tuple.getStringByField("serverIP"));
		this.setHttpStatus(tuple.getStringByField("httpStatus"));
		this.setReqUrlPath(tuple.getStringByField("reqUrlPath"));
		this.setReqTime(tuple.getStringByField("reqTime"));
		this.setCounts(tuple.getLongByField("counts"));
		this.setRespTime(tuple.getDoubleByField("sums"));

		// "appName", "serverIP", "reqUrlPath", "httpStatus", "reqTime",
		// "req_date", "counts", "respTimeSum", "sizeSum"
	}

	public static void main(String[] args) {
		String url = "/ticketorder/showOrderList.htm?sss=aa";
